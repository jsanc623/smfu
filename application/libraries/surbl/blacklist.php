...
class Blacklist {
    ...
    function _three_level_tlds($domain) {
        $three_level_tlds_data = file("/websites/smfu.in/handlers/surbl/three-level-tlds.data");
    ...
    function _two_level_tlds($domain) {
        $two_level_tlds_data = file("/websites/smfu.in/handlers/surbl/two-level-tlds.data");
